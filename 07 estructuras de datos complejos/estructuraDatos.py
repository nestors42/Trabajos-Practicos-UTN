...
def invertir_diccionario_capitales(diccionario_original):
    diccionario_invertido = {}
    
    # Iteramos sobre el diccionario original
    for pais, capital in diccionario_original.items():
        # la 'capital' se convierte en la CLAVE, y el 'pais' en el VALOR.
...
capitales_paises = invertir_diccionario_capitales(paises_capitales)
